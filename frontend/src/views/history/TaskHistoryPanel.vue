...
<template>
  <div class="history-detail-stack">
    ...
    <section class="panel history-detail-card"><h2>法律基础信息快照</h2><dl class="history-definition-grid"><div><dt>法律名称</dt><dd>{{ detail.lawBaseInfoSnapshot.name }}</dd></div><div><dt>发布机关</dt><dd>{{ detail.lawBaseInfoSnapshot.issuingAuthority }}</dd></div><div><dt>发布日期</dt><dd>{{ detail.lawBaseInfoSnapshot.publicationDate }}</dd></div><div><dt>效力状态</dt><dd>{{ detail.lawBaseInfoSnapshot.validityStatus }}</dd></div></dl></section>
